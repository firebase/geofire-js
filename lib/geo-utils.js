var Blah = function() {
  var thisIsALongName = 5;
  var anotherLongName = 7;
  var qqq = thisIsALongName + anotherLongName;
  console.log("test blah: " + qqq);
}
...
function searchRadius(srcHash, radius, setAlert, cb) {
